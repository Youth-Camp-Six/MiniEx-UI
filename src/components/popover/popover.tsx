...
export const Popover: React.FC<PopoverProps> = (props) => {
    let { className, trigger, placement, triggerTarget, arrow, children, childrenData, ...restProps } = props;
    let instance: any;
    let bodyRef: any
    let triggerRef: any
    ...
    return (
        <div className={classes} {...restProps}>
            <label ref={el => { triggerRef = el }}>
                <div className="trigger">{children}</div>
            </label>
            <div ref={el => { bodyRef = el }} className="mi-popover-body">
                {childrenData}
            </div>
        </div>
    );
