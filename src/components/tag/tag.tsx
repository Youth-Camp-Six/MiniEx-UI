...
export const Tag: React.FC<TagProps> = (props) => {
    const { className, size, type, maxWidth, disabled, to, bold, children, round, closable, ...restProps } = props;
    ...
    return (
        <div className={classes} style={{ maxWidth: `${maxWidth}` }} {...restProps} onClick={() => { }}>
